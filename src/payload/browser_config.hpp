    ...
    inline const std::map<std::string, BrowserConfig> GetConfigs() {
        ...
        return {
            ...
            {"brave", {"Brave", L"brave.exe",
                ...
                std::nullopt,  // IElevator2 TBD - Brave will follow Chrome's pattern
            ...
            {"edge", {"Edge", L"msedge.exe",
                ...
                {0xC9C2B807, 0x7731, 0x4F34, {0x81, 0xB7, 0x44, 0xFF, 0x77, 0x79, 0x52, 0x2B}},  // IEdgeElevator
                std::nullopt,  // Edge uses different interface chain
